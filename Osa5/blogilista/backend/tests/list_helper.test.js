...
describe('author with most combined likes on their blogs', () => {
  const listWithOneBlog = [
    {
      _id: '5a422aa71b54a676234d17f8',
      title: 'Go To Statement Considered Harmful',
  ...
  test('of empty list is null', () => {
    expect(listHelper.authorMostLikes([])).toEqual(null)
  })

  test('when list has only one blog', () => {
    expect(listHelper.authorMostLikes(listWithOneBlog)).toEqual({
      author: 'Edsger W. Dijkstra',
      likes: 5,
    })
  })
  ...
  test('of a bigger array', () => {
    expect(listHelper.authorMostLikes(listWithManyBlogs)).toEqual({
      author: 'Edsger W. Dijkstra',
      likes: 17,
    })
  })
